...
namespace WebShopPets.Controllers
{
    public class HomeController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            var listVPP = db.PRODUCTS.Where(x => x.CATEGORy.ID == 4);
            ViewBag.ListThu3 = listVPP;

            var listHotTrend = db.PRODUCTS.Where(x => x.CATEGORy.ID == 12);
            ViewBag.ListThu4 = listHotTrend;
            LoadCategories();
