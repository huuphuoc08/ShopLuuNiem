    ...
    public class ORDERsController : BaseController
    {
        ...
        public ActionResult Create(int ProductID, int Quantity)
        {
            ...
            else
            {
             ...
             return Json(new { Message = "Thêm vào giỏ hàng thành công!", Quantity = quan, orders = list.Count}, JsonRequestBehavior.AllowGet);
        ...
        public ActionResult PayOrder(string ADDRESS, string PHONE)
        {
            ...
            if (order != null)
            {
                ...
                foreach(var item in list)
                {
                    ...
                    totalamount += item.QUANTITY * (item.PRODUCT.PRICE*1000-(item.PRODUCT.PRICE*item.PRODUCT.DISCOUNT*10));
                    db.SaveChanges();
                }
            }
